        ...
        {!examFinished ? (
          ...
          >
            <motion.div
              ...
              style={{
                background: `conic-gradient(${score >= 70 ? '#22c55e' : '#ef4444'} ${score}%, #e2e8f0 0)`
              }}
            >
              <div className="w-24 h-24 rounded-full bg-white flex items-center justify-center">
                <div className={`text-3xl font-bold ${score >= 70 ? 'text-success' : 'text-danger'}`}>
                  {score}%
                </div>
              </div>
            </motion.div>
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-6">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="text-left">
                  ...
                  <div className="font-semibold">{formatTime((30 * 60) - timeLeft)}</div>
                </div>
                <div className="text-left">
                  <div className="text-sm text-gray-500">Result</div>
                  <div className={`font-semibold ${score >= 70 ? 'text-success' : 'text-danger'}`}>
