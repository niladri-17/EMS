      ...
      >
        ...
        <div className="bg-white rounded-2xl shadow-soft p-8 backdrop-blur-sm bg-white/90">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-display font-semibold text-gray-800">Welcome John</h2>
          ...
          <div className="bg-blue-50 border-l-4 border-primary rounded-lg p-4 mb-6">
            <p className="text-sm text-gray-700">
              We've sent a password code to your email address. Please check your inbox and enter the code below to continue.
            </p>
          </div>
          
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="password" className="block text-sm font-medium text-gray-700 mb-1">Password Code</label>
            ...
            >
              ...
              {isLoading ? 'Logging in...' : 'Proceed to Exam'}
            </motion.button>
          </form>
        </div>
        
        <p className="text-center mt-6 text-sm text-gray-600">
          Need help? Contact <a href="#" className="text-primary hover:text-primary-700 font-medium">exam@support.com</a>
        </p>
      </motion.div>
    </div>
  );
