            ...
            >
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 mt-1 text-sm">
                    We need access to your camera to monitor you during the exam to prevent cheating.
                  </p>
                </div>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 mt-1 text-sm">
                    The exam must be taken in fullscreen mode to prevent accessing other resources.
                  </p>
                </div>
                <div className="ml-4 flex items-center">
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 mt-1 text-sm">
                    We need access to your microphone to detect any suspicious sounds or conversations.
                  </p>
                </div>
                <div className="ml-4 flex items-center">
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 mt-1 text-sm">
                    We will detect if you switch to another tab or application during the exam.
                  </p>
                </div>
                <div className="ml-4 flex items-center">
