...
const ExamPreparationPage = () => {
  const { setIsExamPrepared } = useStudentStore();
                  ...
                  <div>
                    ...
                    <ul className="space-y-3 text-gray-700">
                      ...
                      <li className="flex items-start">
                        ...
                        <span className="ml-2">
                          Ensure your webcam is on at all times
                        </span>
                      </li>
                      <li className="flex items-start">
                        <div className="flex-shrink-0 h-5 w-5 rounded-full bg-primary-700 flex items-center justify-center text-white text-xs mt-0.5">
                    ...
                    <div className="flex">
                      ...
                      <div className="ml-3">
                        <p className="text-sm text-yellow-800">
                          If you exit fullscreen mode, switch tabs, or disable
                          your webcam, your exam may be automatically terminated
                          after a 10-second warning.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  {!isActive && (
                    <div className="my-4 p-3 bg-red-50 border-l-4 border-red-500 rounded-lg">
                      <p className="text-sm text-red-700">
                        <span className="font-bold">Required:</span> Your webcam
                        must be enabled to take the exam. Please allow webcam
