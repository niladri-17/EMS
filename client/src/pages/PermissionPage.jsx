...
const PermissionPage = () => {
  ...
  const { requestPermission, hasPermission, isActive, videoRef, reconnect } =
    useWebcam();
  const {
    isFullscreen,
    enterFullscreen,
  ...
  const requestFullscreenPermission = async () => {
    try {
      if (!isFullscreenAvailable()) {
        setError(
          "Fullscreen is not supported in your browser. Please try another browser."
        );
        return;
      }
      ...
      if (result) {
        ...
        setError(
          "Fullscreen permission was denied. Please allow fullscreen mode to continue."
        );
      }
    } catch (error) {
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 mt-1 text-sm">
                      We need access to your camera to monitor you during the
                      exam to prevent cheating. If your webcam is turned off
                      during the exam, it will be flagged as a violation.
                    </p>
                  </div>
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 mt-1 text-sm">
                      ...
                      accessing other resources. Exiting fullscreen during the
                      exam will be flagged as a violation.
                    </p>
                  </div>
                  <div className="ml-4 flex items-center">
                    {permissions.fullscreen ? (
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 mt-1 text-sm">
                      ...
                      sounds or conversations during the exam.
                    </p>
                  </div>
                  <div className="ml-4 flex items-center">
                    {permissions.microphone ? (
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 mt-1 text-sm">
                      ...
                      during the exam. Any tab or application switching will be
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 mt-1 text-sm">
                      ...
                      disqualification. This includes webcam disconnections,
                      exiting fullscreen, or switching tabs.
                    </p>
                  </div>
                  <div className="ml-4 flex items-center">
                    {permissions.browserWarning ? (
              ...
              <motion.div className="md:col-span-2" variants={itemVariants}>
                    ...
                    <div className="flex items-center">
                      ...
                      >
                        {permissions.camera
                          ? isActive
                            ? "Camera active"
                            : "Camera inactive - please reconnect"
                          : "Camera permission required"}
                      </span>
                    </div>
                    <div className="flex items-center">
                      <div
                        className={`w-4 h-4 rounded-full mr-2 ${
                          permissions.fullscreen ? "bg-green-500" : "bg-red-500"
                        }`}
                      ></div>
                      <span
                        className={`text-sm ${
                ...
                >
                  ...
                  <p className="text-sm text-yellow-700">
                    During the exam, if your webcam is turned off, you exit
                    fullscreen mode, or switch tabs, your exam may be
                    automatically terminated after a 10-second warning.
                  </p>
                </motion.div>
              </motion.div>
            </div>
